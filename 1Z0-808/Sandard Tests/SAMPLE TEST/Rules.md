...
* Method invocation conversions allowed:
  ...
  * a boxing conversion (JLS 5.1.7) optionally followed by widening reference conversion (a widening reference conversion exists from any reference type S to any reference type T, provided S is a subtype (ง4.10) of T)
